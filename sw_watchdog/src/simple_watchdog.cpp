...
void print_usage()
{
  std::cout << "Usage: simple_watchdog lease [" << OPTION_AUTO_START <<
    "] [-h]\n\n"
    "required arguments:\n"
...
/**
 * Internally relies on the QoS liveliness policy provided by rmw implementation
 * (e.g., DDS). The lease passed to this watchdog has to be > the period of the
 * heartbeat signal to account for network transmission times.
 */
